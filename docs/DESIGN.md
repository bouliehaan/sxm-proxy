# sxm-proxy — design notes

Why the bridge behaves the way it does. For installing and running it, see the
[README](../README.md).

## Why the image compiles upstream rather than repackaging it
